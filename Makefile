...
STUDENT_EDITABLE_FILES=conv2d_solution.hpp config.make
...
autograde: conv2d.exe 
	./conv2d.exe -M 3300 -o bench.csv -v -s 2048 -k 127 -i 1 -f conv2d_reference_c conv2d_solution_c
	./conv2d.exe -M 3300 -o correctness.csv -v -s 1024 2048 -k 31 63 -i 1 -f conv2d_reference_c conv2d_solution_c
...
conv2d.exe: $(BUILD)conv2d_main.o  $(BUILD)conv2d.o $(BUILD)perfstats.o
	$(COMPILER) $(conv2d_OPTIMIZE) $(BUILD)conv2d_main.o  $(BUILD)perfstats.o $(BUILD)conv2d.o -o conv2d.exe
